...
class CreateEnvironmentOfficersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('environment_officers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('environment_officers');
    }
}
