...
class CreateTelecommiunicationTowersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('telecommiunication_towers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('telecommiunication_towers');
    }
}
