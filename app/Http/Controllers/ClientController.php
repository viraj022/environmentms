...
class ClientController extends Controller
{
    ...
    public function findClient_by_id($id)
    {
        ...
        //    PaymentType::get();
        $file = Client::with('epls')->with('siteClearenceSessions.siteClearances')->with('environmentOfficer.user')->with('oldFiles')->with('industryCategory')->with('businessScale')->with('pradesheeyasaba')->with('siteClearenceSessions.client.certificates')->find($id)->toArray();
