...
class ComplainController extends Controller
{
    ...
    public function update_complain(Request $request, $id)
    {
        ...
        if ($request->hasFile('complain_attach')) {
            $attach = $request->file('complain_attach')->store('public/complain_attachments/' . $id);
            $update_complain->attachment =  $attach;
        }
