...
Route::middleware('auth:api')->post('/user/active/{id}', 'UserController@activeDeletedUser'); //restore deleted users
/*
{
    "id": 1,
    "message": "true"
...
Route::middleware('auth:api')->post('/attachement/id/{id}', 'AttachemntsController@store'); //update attachment



Route::middleware('auth:api')->post('/attachement/id/{id}', 'AttachemntsController@destroy'); //delete attachment
...
Route::middleware('auth:api')->post('/payment_type/id/{id}', 'PaymentTypeController@store'); //update Payment type
/*
  {
  "name": "cash "
  }
 ...
 */
Route::middleware('auth:api')->post('/payment/id/{id}', 'PaymentsController@store'); //update Payment type
/*
  {
  "name": "cash "
  }
...
Route::middleware('auth:api')->post('/payment/id/{id}', 'PaymentsController@destroy'); //deletePayment
/*
  {
  "id": 1,
  "message": "true"
 ...
 */
Route::middleware('auth:api')->post('/rangedpayment/id/{id}', 'PaymentsController@destroyRangedPayment'); //deletePayment
/*
  {
  "id": 1,
  "message": "true"
...
Route::middleware('auth:api')->post('/unassistantdirector/id/{id}', 'AssistantDirectorController@destroy'); //delete AssistantDirector
/*
  server responce
...
Route::middleware('auth:api')->post('/environment_officers/id/{id}', 'EnvironmentOfficerController@destroy'); // ! delete an environment officer by id
/*
  ! output
...
Route::middleware('auth:api')->post('/client/id/{id}', 'ClientController@store'); //update Client
...
Route::post('/reset_counts', [ResetSettingsController::class, 'reset_site_counts']);
