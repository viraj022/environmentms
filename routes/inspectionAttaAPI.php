...
Route::middleware('auth:api')->delete('/epl/inspection/attach/id/{id}', 'InspectionSessionAttachmentController@createEPlInspection'); //   create a new inspection session 
