                        ...
                        <div class="card card-gray">
                                ...
                                <form id="old_data_form">
                                    <div class="eplSection legitSection mt-2 d-none">
                                        <div class="form-group">
                                            ...
                                            <div><input id="getEPLCode" name="getEPLCode" type="text"
                                                    class="form-control form-control-sm" required=""
                                                    placeholder="Enter Code..." value=""></div>
                                            {{-- <div id="valEPL" class="d-none"><p class="text-danger">EPL is required</p></div> --}}
                                        </div>
                                        <div class="form-group">
                                            <label>Remark*</label>
                                            <div>
                                                <input id="getRemark" name="getRemark" type="text"
                                                    class="form-control form-control-sm" required=""
                                                    placeholder="Enter Remark..." value="Limited">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="issue_date" name="datepickerUiIssue" type="text"
                                                    data-date="" data-date-format="YYYY MM DD" max="2999-12-31"
                                                    class="form-control form-control-sm" required=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="expire_date" name="datepickerUiExp"
                                                    max="2999-12-31"class="form-control form-control-sm " required=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="getsubmitDate" name="datepickerUiSubmit" max="2999-12-31"
                                                    class="form-control form-control-sm" required=""
                                                    placeholder="Enter Submit Date..." value="">
                                            </div>
                                        </div>
                                        <div class="form-group showCertificateNo">
                                            <label>Certificate No*</label>
                                            <input id="getcertifateNo" type="text" name="getcertifateNo"
                                                class="form-control form-control-sm" required=""
                                                placeholder="Enter Certificate No..." value="">
                                        </div>
                                        <div class="form-group">
                                            <label>Previous Renews*</label>
                                            <div class="input-group">
                                                <select id="getPreRenew" name="getPreRenew"
                                                    class="form-control form-control-sm" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="last_certificate" name="last_certificate" type="file"
                            ...
                            <div class="card-footer">
                                ...
                                @if ($pageAuth['is_delete'] == 1 || false)
                                    <button id="btnshowDelete" type="submit"
                                        class="btn btn-danger d-none">Delete</button>
                                @endif
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="card assignFileToOffier">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-sm combo_AssistantDirector"
                                                        id="ass_dir_combo"></select>
                                                </div>
                                                <div class="form-group">
                                                    <label>Environment Officer</label>
                                                    <select class="form-control form-control-sm combo_envOfficer"
                                                        id="env_officer_combo"></select>
                                                </div>
                                                <div class="form-group">
                                                    <button id="btnAssignEnv" type="submit"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <div class="card-body table-responsive" style="height: 450px;">
                                                    <div class="form-group">
                                                        <label>Upload: </label>
                                                        <input id="otherFiles" accept="application/pdf,image/*"
                                                            type="file">
                                                        @if ($pageAuth['is_create'] == 1 || false)
                                    ...
                                    <div class="card-body" style="height: 70%; width: 60%;">
                                        <div class="card card-widget card-dark">
                                            ...
                                            <div class="card-body" style="display: block;">
                                                <a id="addCertificateURL" target="_blank" href=""><img
                                                        class="img-fluid pad lastCertificatePath" src="#"
                                                        alt="Certificate"></a>
                                            </div>
                                        </div>
                                    </div>
...
@section('pageScripts')
    ...
    <script>
                ...
                if (load_val === '01') {
                    checkEPLExist(PROFILE, function(result) {
                        ...
                        if (result.length === 0) {
                            ...
                            if (result.path != null) {
                                (result.path.split('.')[1] == 'pdf') ? $('.lastCertificatePath')
                                    .attr('src', '/dist/img/pdf-view.png'): $(
        ...
        $('#btnAssignEnv').click(function() {
            let obj = {
                environment_officer_id: parseInt($("#env_officer_combo").val()),
                epl_id: PROFILE
            };
