...
<body>
    <div id="wrapper">
        ...
        <div class="content">
            <p>Dear Mr. Firstname Lastname,</p>
            <p>
                Thank you for your <strong>renewal request</strong> for
                <strong>Business Name PVT Ltd.</strong>.
            </p>
            <p>
            ...
            <div class="payment-info">
                <div><a href="#" class="payment-link">Click to Pay</a></div>
                <div class="instructions">
                    <small>
                        Please note that you will be redirected to the online payment gateway for payment and no card
                        details will be retained by the authority.
                    </small>
                </div>
            </div>
