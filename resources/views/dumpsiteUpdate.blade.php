                ...
                <div class="row">                   
                        <div class="col-md-5">
                            <div class="card card-primary">
                                ...
                                <form method="POST" action="/dumpsite/id/{{$dumpSite['id']}}">
                                    <div class="card-body">
                                        @csrf    
                                        @method('PUT')   
                                        @if($pcName != null)                                     
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" rows="3" placeholder="Enter Address"
                                                      name="address">{{$dumpSite['address']}}</textarea>
                                            @error('address')
                    ...
                    <div class="col-md-7">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <table class="table table-condensed assignedPrivilages" id="tblUsers">
                                    ...
                                    <tbody>
                                                                        @foreach($dumpSites as $indexKey=>$s)
                                                                            <tr>
                                                                                <td>{{$indexKey+1}}.</td>
                                                                                <td>{{$s['name']}}</td>
                                                                                <td>{{$s['type']}}</td>                                                                             
                                                                                <td>
                                                                                    <a href="/dumpsite/id/{{$s['id']}}"
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <h3 class="card-title"><b>Remove dump site'{{$dumpSite['name']}}'</b></h3>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="alert alert-danger alert-dismissible">
                                        ...
                                        Deleting selected dump site is not reversible. <br>
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-danger">
                        <div class="modal-header">
                            <h4 class="modal-title">Delete Dump Site</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p><b>Are you sure you want to permanently delete this dump site ? </b></p>
                            <p>Once you continue, this process can not be undone. Please Procede with care.</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                            <form action="/dumpsite/id/{{$dumpSite['id']}}" method="POST">
                                @csrf
                                @method('DELETE')
