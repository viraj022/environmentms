                    ...
                    <div class="col-md-12">
                        <div class="card card-gray">
                            <div class="card-header">
                                <div class="card-title">Industry Files</div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div id="valfileType" class="d-none">
                                                <p class="text-danger">Field is required</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div id="valInspection" class="d-none">
                                    <p class="text-danger">Field is required</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modal-x2">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" id="setInspectionVal2" class="btn btn-primary d-none"><i
                                    class="fa fa-check"></i> Set Inspection</button>
                            <button type="button" id="needApproval" class="btn btn-primary d-none"><i
                                    class="fa fa-check"></i> AD Approval</button>
                            <button type="button" id="submitAdCerApproval" class="btn btn-primary d-none"><i
                                    class="fa fa-check"></i> Submit For AD Certificate Approval</button>
                            <button type="button" id="rejectAdCerApproval" class="btn btn-danger d-none"><i
        ...
        $(document).on('click', '#rejectAdCerApproval', function() {
            if ($('#getMinutes').val() != '') {
                ...
                if (confirm('Are you sure you want to reject?')) {
                    rejectCertificateApproval(fileData.id, fileData.environment_officer_id, minute(), function(
                        resp) {
                        show_mesege(resp);
                        if (resp.id == 1) {
                            $('#modal-x2').modal('hide');
