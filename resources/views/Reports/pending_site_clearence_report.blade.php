                            ...
                            <table class="table table-condensed" id="pending_site_clear_report">
                                ...
                                <tbody>
                                  @foreach ($pending_site_clear_data as $data)
                                     <tr>
                                         <td>{{ ++$loop->index }}</td>
                                         <td><a href="{{ (!isset($data->siteClearenceSession->client)) ? '-' : '/industry_profile/id/{{ $data->siteClearenceSession->client->id '}}" class="btn btn-dark" target="_blank">{{ (!isset($data->siteClearenceSession->client)) ? '-' : $data->siteClearenceSession->client->file_no }}</a></td>
