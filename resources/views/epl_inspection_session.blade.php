            ...
            <div class="col-md-5">
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Add New Session</label>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Remark*</label>
                            <input id="getRemarkData" type="text" class="form-control form-control-sm"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="card-body table-responsive" style="height: 450px;">
                                            <table class="table table-condensed" id="tblInspection">
                                                <thead>
                                                    <tr>
...
<script src="/../../js/EPLInspectionJS/submit.js"></script>
<script src="/../../js/EPLInspectionJS/get.js"></script>
<script src="/../../js/EPLInspectionJS/update.js"></script>
