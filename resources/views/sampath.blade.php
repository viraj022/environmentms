                        ...
                        <div class="col-md-5">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <label>Sampath Kendraya Registration</label>
                                </div>

                                <form method="POST" action="/sampath">
                                    <div class="card-body">
                                        @csrf
                                        @if($provinces!=null)
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <table class="table table-condensed assignedPrivilages" id="tblUsers">
                                    ...
                                    <tbody>
                                                                        @foreach($sampathkendrayas as $indexKey=>$sampathkendraya)
                                                                            <tr>
                                                                                <td>{{$indexKey+1}}.</td>
                                                                                <td>{{$sampathkendraya['name']}}</td>
                                                                                <td>{{$sampathkendraya['type']}}</td>                                                                                
                                                                                <td>
                                                                                    <a href="/sampath/id/{{$sampathkendraya['id']}}"
