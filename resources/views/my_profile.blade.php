...
@endsection
@section('content')
    @if ((isset($pageAuth['is_read']) && $pageAuth['is_read'] == 1) || true)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="userName" type="text" disabled class="form-control form-control-sm"
                                            placeholder="Enter User Name" value="{{ $user['user_name'] }}">
                                        @error('roll')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="contactNo" type="text" disabled class="form-control form-control-sm"
                                            placeholder="Enter Contact No" value="{{ $user['contact_no'] }}">
                                        @error('contactNo')
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input name="email" type="text" disabled class="form-control form-control-sm"
                                    ...
                                    <div class="form-group">
                                        <label>NIC</label>
                                        <input name="nic" type="text" disabled class="form-control form-control-sm"
                                            maxlength="12" minlength="10" placeholder="Enter NIC"
                                            value="{{ $user['nic'] }}">
                                        @error('nic')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="password_confirmation" type="password"
                                                class="form-control form-control-sm" placeholder="Re-enter Password">
