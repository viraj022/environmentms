    ...
    <div class="card card-success card-outline card-outline-tabs col-md-12">
        <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="complain-assign-tab" data-toggle="pill" href="#complain-assign" role="tab" aria-controls="complain-assign" aria-selected="false">Assign Complain</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                ...
                <div class="tab-pane" id="custom-tabs-three-attachments" role="tabpanel" aria-labelledby="custom-tabs-three-attachments">
                    <section class="content-header">
                        ...
                        <div class="form-group" id="fileUpDiv">
                            ...
                            <input id="fileUploadInput" type="file" class="col-12" accept=".png, .jpg, .jpeg" multiple>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="card card-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <form id="complain_assign_frm" class="w-50">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @if($comp_assigned_user[0]['assignedUser'] != null && $comp_assigned_user[0] != null)
                                                    <span>{{$comp_assigned_user[0]['assignedUser']['user_name']}}</span>
                                                    @else
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 mt-3">
                                                @foreach($comments_of_complain as $comment)
                                                <div class="alert alert-success w-100" role="alert">
                                                    <h6><a>{{$comment->comment}}</a></h6>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <form id="minutes_frm">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary" id="add_minute"> Add Minute </button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-8 mt-3">
                                                @foreach($complain_minutes as $minute)
                                                <div class="alert alert-success w-100" role="alert">
                                                    <h6><a>{{$minute->minute}}</a></h6>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
