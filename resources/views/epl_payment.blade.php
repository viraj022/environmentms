                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input id="paymnt_amount" type="number" class="form-control form-control-sm"
                                        placeholder="" value="">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-sm btn-dark"
                                            id="inspection_payBtn">Add</button>
                                    </div>
                                    <!-- /btn-group -->
                                </div>
                                ...
                                <div id="fineDev" class="d-none">
                                    ...
                                    <div class="input-group mb-3">
                                        <input id="fine_amt" type="number" class="form-control form-control-sm"
                                            placeholder="" value="">
                                        <div class="input-group-prepend">
                                ...
                                <div class="input-group mb-3">
                                    <input id="cert_amt" type="number" class="form-control form-control-sm" placeholder=""
                                        readonly="" value="">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-sm btn-dark"
                                            id="certificate_payBtn">Add</button>
                                    </div>
                                    <!-- /btn-group -->
                                </div>
                            </div>
                            <div class="card-footer">
                                @if ($pageAuth['is_create'] == 1 || false)
                                    <button id="btnSave" type="submit" class="btn btn-success pull-right"><i
                                            class="fa fa-print"></i> &nbsp;Complete</button>
                                @endif
                            </div>
                        </div>
                    </div>
