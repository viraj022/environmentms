    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 col-sm-6">
                <h1>File No: (<a href="/industry_profile/id/{{$client}}">{{$file_no}}</a>) - Committee</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <input id="getSiteClearanceId" value="{{$id}}" type="text" class="form-control form-control-sm d-none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="date" name="datepickerUi" type="text" data-date="" data-date-format="YYYY MM DD" max="2999-12-31" class="form-control form-control-sm" placeholder="Enter Issue Date..." value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Member*</label>
...
//Select button action 
    ...
    function add_itemToBill() {
        ...
        ITEM_LIST.push({id: member_id, first_name: member_name});
