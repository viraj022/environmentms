                                                    ...
                                                    <dl class="row">
                                                        ...
                                                        <dt class="col-sm-7">
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <input type="text" id="man_cert_ref_no" class="form-control" placeholder="Enter reference number here">
                                                                <button type="button" id="save_man_ref_no" class="btn btn-success mt-2">Save Reference
                                                                    No</button>
                                                            </div>
                                                        </dt>
                                                    </dl>
                                                </div>
                                                <button class="btn btn-primary genCertificateNum m-1 d-none"><i class="fa fa-gear"></i> Generate Certificate
                                                    Number</button>
                                                <!-- /.card-body -->
                                            </div>
                                        </div>
                                    ...
                                    <div class="card card-success">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="uploadFileSection">
                                                ...
                                                <button class="btn btn-dark navToFile1"><i class="fas fa-file-upload"></i> Upload
    ...
    $('#uploadCerfile').click(function() {
        ...
        if (file_input != '') {
            if (uploaded_file_path != '') {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Certificate file will be updated!",
                    icon: 'warning',
