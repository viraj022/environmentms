            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div class="form-group" id="comboAssistantDirectorDisplay">
                        ...
                        <select id="getAssistantDirector" class="form-control form-control-sm select2 select2-purple combo_AssistantDirector" data-dropdown-css-class="select2-purple" style="width: 100%;" name="level">
                ...
                <div class="card-footer">
                    ...
                    <button id="btnSave" type="submit" class="btn btn-success">Assign</button>
                    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            <div class="modal-header">
                <h4 class="modal-title">Un Assign Selected Environment Officer</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p><b>Are you sure you want to Un Assign Selected Environment Officer? </b></p>
                <!-- <p>Once you continue, this process can not be undone. Please Procede with care.</p> -->
                <p>Please Procede with care.</p>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                <button id="btnDelete" type="submit" class="btn btn-outline-light" data-dismiss="modal">Un Assign</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
