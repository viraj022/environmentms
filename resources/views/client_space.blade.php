                                ...
                                <div class="card card-gray">
                                    ...
                                    <div class="card-footer">
                                        @if ($pageAuth['is_create'] == 1 || false)
                                            <button id="btnSave" type="submit" class="btn btn-success"><i
                                                    class="fas fa-check"></i>
                                                Register</button>
                                        @endif
                                        @if ($pageAuth['is_update'] == 1 || false)
                                            <button id="btnUpdate" type="submit"
                                                class="btn btn-warning d-none">Update</button>
                                        @endif
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="card card-gray">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select id="getDtaType"
                                            ...
                                            data-dropdown-css-class="select2-purple" style="width: 60em;" name="level">
                                ...
                                <div class="card-footer">
                                    @if ($pageAuth['is_create'] == 1 || false)
                                        <button id="btnSearch" type="submit" class="btn btn-success"><i
                                                class="fas fa-search"></i>
                                            Search</button>
                                        <button id="btnRegister" class="btn btn-primary"><i class="fas fa-plus"></i>
                                            Register New
                                            Client</button>
                                    @endif
