                        ...
                        <div class="card card-primary card-tabs">
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="nav-pending-cert-tab" data-toggle="pill"
                                            href="#pending-cert" role="tab" aria-controls="pending-cert"
                                            aria-selected="true">Pending Certificates</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="nav-fowarded-letters-tab" data-toggle="pill"
                                                ...
                                                <div class="card-body p-0">
                                                    <div class="card-body table-responsive" style="height: 450px;">
                                                        ...
                                                        <table class="table table-condensed mt-2"
                                                            id="tblPendingCertificate">
                                                            <thead>
                                                                <tr>
                                                                    <th style="width: 5em">#</th>
                                                                    <th style="width: 30em">Client Name</th>
                                                                    <th style="width: 20em">Industry Name</th>
                                                                    <th style="width: 35em">EPL Code</th>
                                                                    <th style="width: 35em">Site Clearance Code</th>
                                                                    <th style="width: 40em">File No</th>
                                                                    <th>Nominate</th>
                                                                    <th style="width: 20em">File Status</th>
            ...
            ajaxRequest('GET', url, null, function(resp) {
                ...
                $.each(resp, function(key, value) {
                    ...
                    letter_view_tbl += "<tr><td>" + key + "</td><td>" + value.complainer_code +
                        ...
                        "</td><td>" + value.comp_contact_no +
                        "</td></td><td style='width: 10%'><a href='/complain_profile/id/" + value
                        .id +
                        "' class='btn btn-dark'>View</a></td></tr>";
                });
